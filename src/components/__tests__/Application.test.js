...
import { render, cleanup, waitForElement, fireEvent, prettyDOM, getByText, getAllByTestId, getByPlaceholderText, getByAltText, queryByText, queryByAltText, getByTestId } from "@testing-library/react";
...
describe('Application', () => {
  ...
  test("shows the save error when failing to save an appointment", async () => {
    ...
    expect(
      getByText(appointment, "Whoopsie Error on Saving")
    ).toBeInTheDocument();
  ...
  test("shows the delete error when failing to save an appointment", async () => {
    ...
    expect(
      getByText(appointment, "Whoospie Error on Deleting")
    ).toBeInTheDocument();
